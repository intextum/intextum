...
from services.content.indexed_content_records import (
    ...
    _build_attachment_record_values,
    _build_directory_record_values,
    _build_email_message_record_values,
    _build_file_record_values,
    _content_kind_value,
    _email_file_record_values,
    _new_file_task_state,
)
